...
const PrivacyPolicy: React.FC = () => {
	...
	return (
		<main className={styles['privacy-policy']}>
			...
			<div className={`${styles['privacy-policy__special-block']} ${styles['privacy-policy__special-block--left']}`} />
			<div className={`${styles['privacy-policy__special-block']} ${styles['privacy-policy__special-block--right']}`} />
		</main>
	);
};
